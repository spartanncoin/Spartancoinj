...
import com.google.spartancoin.wallet.AllowUnconfirmedCoinSelector;
...
public class PaymentChannelClientState {
     ...
     * overriding {@link PaymentChannelClientState#editContractSendRequest(com.google.spartancoin.core.Wallet.SendRequest)}.
