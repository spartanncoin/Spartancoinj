...
import com.google.spartancoin.crypto.TransactionSignature;
...
import static com.google.spartancoin.core.Utils.NEGATIVE_ONE;
import static com.google.spartancoin.core.Utils.bitcoinValueToFriendlyString;
import static com.google.spartancoin.core.Utils.doubleDigest;
import static com.google.spartancoin.core.Utils.reverseBytes;
import static com.google.spartancoin.core.Utils.uint32ToByteStreamLE;
...
public class Transaction extends ChildMessage implements Serializable {
     ...
     */
    public static final BigInteger REFERENCE_DEFAULT_MIN_TX_FEE = CoinParams.DEFAULT_MIN_TX_FEE;
     ...
     */
    public static final BigInteger MIN_NONDUST_OUTPUT = CoinParams.MIN_NONDUST_OUTPUT;
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.google.spartancoin.script.Script, ECKey, com.google.spartancoin.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.google.spartancoin.core.Transaction.SigHash, boolean)}
