...
import com.google.spartancoin.crypto.KeyCrypter;
import com.google.spartancoin.crypto.KeyCrypterException;
import com.google.spartancoin.crypto.KeyCrypterScrypt;
import com.google.spartancoin.script.Script;
import com.google.spartancoin.script.ScriptBuilder;
import com.google.spartancoin.script.ScriptChunk;
...
import com.google.spartancoin.utils.ListenerRegistration;
import com.google.spartancoin.utils.Threading;
import com.google.spartancoin.wallet.*;
...
import org.spartancoinj.wallet.Protos.Wallet.EncryptionType;
...
import static com.google.spartancoin.core.Utils.bitcoinValueToFriendlyString;
import static com.google.spartancoin.core.Utils.bitcoinValueToPlainString;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.spartancoin.wallet.WalletFiles.Listener)}
...
public class Wallet implements Serializable, BlockChainListener, PeerFilterProvider {
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link com.google.spartancoin.core.Wallet#getBalance()} - the fees required
         ...
         *
         * <p>Once {@link Wallet#completeTx(com.google.spartancoin.core.Wallet.SendRequest)} is called, this is set to the
        ...
        /**
         * If not null, the {@link com.google.spartancoin.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.spartancoin.wallet.WalletFiles.Listener)}
     ...
     * of {@link com.google.spartancoin.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.google.spartancoin.crypto.KeyCrypter,
     ...
     * {@link com.google.spartancoin.crypto.KeyCrypterScrypt}.
     *
    ...
    /**
     * <p>Convenience wrapper around {@link Wallet#addNewEncryptedKey(com.google.spartancoin.crypto.KeyCrypter,
     ...
     * you can use {@link com.google.spartancoin.utils.Threading#waitForUserCode()} to block until the future had a
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.google.spartancoin.core.TransactionBroadcaster broadcaster) {
     ...
     * {@link com.google.spartancoin.core.PeerFilterProvider} interface and generally should not be used directly by apps.
