...
import com.google.spartancoin.net.ClientConnectionManager;
import com.google.spartancoin.net.FilterMerger;
import com.google.spartancoin.net.NioClientManager;
...
import com.google.spartancoin.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
     ...
     *         Use {@link com.google.spartancoin.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link com.google.spartancoin.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.spartancoin.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link com.google.spartancoin.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.google.spartancoin.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.spartancoin.core.Peer#ping()}.
     */
