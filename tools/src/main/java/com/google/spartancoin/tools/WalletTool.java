...
package com.google.spartancoin.tools;
...
import com.google.spartancoin.store.*;
...
public class WalletTool {
    ...
    private static org.spartancoin.protocols.payments.Protos.PaymentRequest paymentRequest;
    ...
    private static void sendPaymentRequest(String location, boolean verifyPki) {
        if (location.startsWith("http") || location.startsWith("bitcoin")) {
            ...
            try {
                paymentRequest = org.spartancoin.protocols.payments.Protos.PaymentRequest.newBuilder().mergeFrom(stream).build();
            } catch(IOException e) {
